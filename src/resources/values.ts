...
const MONGO_DB_CONNECTION_URL: string = `mongodb+srv://admin:${encodeURIComponent(`@Metropolitan.13`)}@metropolitan.vhiho.mongodb.net/phoenixplatform?retryWrites=true&w=majority&appName=metropolitan`;
